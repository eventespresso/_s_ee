<?php
/**
 * _s_ee functions and definitions
 *
 * @package _s_ee
 */
...
if ( ! function_exists( '_s_ee_setup' ) ) :
/**
...
function _s_ee_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( '_s_ee_custom_background_args', array(
...
add_action( 'after_setup_theme', '_s_ee_setup' );
...
add_action( 'widgets_init', '_s_ee_widgets_init' );
...
add_action( 'wp_enqueue_scripts', '_s_ee_scripts' );
